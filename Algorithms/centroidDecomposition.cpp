...
1)Height of centroid tree is at most logn
2)All nodes in a subtree of the centroid tree are connected in the main tree
3)A subtree of the main tree is a path in the centroid tree
4)Every vertex adjacent to a subtree in the main tree is a parent in the centroid tree
...
Every tree that is adjacent to a node is either in its subtree or a parent.
We can store everything about the subtree and then iterate on the parent
